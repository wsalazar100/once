...
export class Camion extends  ACarga {

    constructor(marca: string='', modelo: string='', anioFabricacion: number=1900, volumenTanque:number=0, tonelajeCarga: number=0) { 
        super(marca, modelo,anioFabricacion,volumenTanque, ENUM_TTRANSPORTE.CARGA, ENUM_TVEHICULO.CAMION, tonelajeCarga ); // must call super()
