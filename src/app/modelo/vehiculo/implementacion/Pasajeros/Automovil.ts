...
export class Automovil extends  APasajeros {

    constructor(marca: string='', modelo: string='', anioFabricacion: number=1900, volumenTanque:number=0, cantidaPasajeros: number=0) { 
        super(marca, modelo,anioFabricacion,volumenTanque, ENUM_TTRANSPORTE.PASAJERO, ENUM_TVEHICULO.CAMIONETA, cantidaPasajeros ); 
